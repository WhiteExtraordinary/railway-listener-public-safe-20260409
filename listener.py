...
# daftar ticker IDX (contoh sebagian, nanti lo isi lengkap)
VALID_TICKERS = {
    "AADI",
    "AALI",
    "ABBA",
...
def open_or_print_url(url: str) -> None:
    # Railway tidak punya browser desktop; defaultnya log URL saja.
    if os.name == "nt" and os.getenv("OPEN_BROWSER", "0") == "1":
        os.startfile(url)
    else:
        print(f"URL: {url}")
...
async def handler(event):
    ...
    for word in words:
        ...
        if ticker in VALID_TICKERS and ticker not in found:
            found.add(ticker)
            url = f"https://www.google.com/finance/beta/quote/{ticker}:IDX"
